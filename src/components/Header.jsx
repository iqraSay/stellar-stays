  ...
  return (
    ...
    <div class="container">
        ...
        <div class="logo-wrapper">
            <Link class="logo" to="/"> <img src={logo} class="logo-img" alt="" /> </Link>
        </div>
        {/* <!-- Button --> */}
        ...
        <div class="collapse navbar-collapse" id="navbar">
            <ul class="navbar-nav mx-auto">
                <li class="nav-item dropdown"> <Link to="/" class="nav-link active" role="button" >Home </Link>
                ...
                <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" to="/rooms" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">Rooms <i class="fa-solid fa-angle-down"></i></a>
                    <ul class="dropdown-menu">
                ...
                <li class="nav-item dropdown"> <Link class="nav-link dropdown-toggle" to="#" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">Services <i class="fa-solid fa-angle-down"></i></Link>
                    <ul class="dropdown-menu">
                        <li><Link to="facilities.html" class="dropdown-item"><span>Facilities</span></Link></li>
                        
                        <li><Link to="amenities.html" class="dropdown-item"><span>Amenities</span></Link></li>
                        <li><Link to="offers.html" class="dropdown-item"><span>Event Venues</span></Link></li>
                    </ul>
                </li>
            ...
            <div class="navbar-right">
                <div class="phonex"><Link to="tel:+12345678910"><i class="fa-solid fa-phone"></i> +1 234 567 8910</Link></div>
            </div>
        </div>
    </div>
</nav>
