...
import rbg from '../../assets/04.jpg'
import r1 from '../../assets/02.jpg'
import r2 from '../../assets/03.jpg'
import r3 from '../../assets/07.jpg'
          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-lg-8 col-md-12 text-center">
                ...
                <h1>Wellness Room</h1>
                <div class="details">
                  <i class="fa-solid fa-bed mr-5"></i>5 Bed
                  <i class="fa-solid fa-expand mr-5"></i>550 Sqm
              ...
              <div class="col-lg-7 col-md-12 mb-30">
                <div class="row mb-30">
                  <div class="col-md-12">
                    ...
                    <p>
                    Designed with relaxation and rejuvenation in mind, this 4-bedroom, 2-bath wellness room offers 550 sqft of space for up to 6 guests. It’s equipped with wellness-inspired features, including a peaceful atmosphere, comfortable furnishings, and a focus on relaxation. Perfect for those seeking a calm, restorative environment, the wellness room includes amenities that promote overall well-being and serenity.
                    </p>
                  </div>
                </div>
                <div class="row">
