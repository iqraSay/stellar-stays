          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-lg-8 col-md-12 text-center">
                ...
                <h1>Family Room</h1>
                <div class="details">
                  <i class="fa-solid fa-bed mr-5"></i>4 Bed
                  <i class="fa-solid fa-expand mr-5"></i>750 Sqm
                  <i class="fa-solid fa-bath mr-5"></i>4 Bathroom
              ...
              <div class="col-lg-7 col-md-12 mb-30">
                <div class="row mb-30">
                  <div class="col-md-12">
                    ...
                    <div class="section-title">Family Room</div>
  
                    <p>
                    A spacious 4-bedroom, 2-bath family room designed to accommodate up to 4 guests. With 750 sqft of space, it offers comfort and privacy for the entire family. The layout includes cozy, well-furnished rooms, a fully equipped kitchen, and a bright, airy living area perfect for family gatherings. This room ensures an enjoyable and relaxed stay with plenty of room for everyone to unwind.
                    </p>
                  </div>
                </div>
                <div class="row">
