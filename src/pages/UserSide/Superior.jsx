...
import rbg from '../../assets/03.jpg'
import r1 from '../../assets/02.jpg'
import r2 from '../../assets/07.jpg'
          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-lg-8 col-md-12 text-center">
                ...
                <h1>Superior Room</h1>
                <div class="details">
                  <i class="fa-solid fa-bed mr-5"></i>3 Bed
                  <i class="fa-solid fa-expand mr-5"></i>600 Sqm
                  <i class="fa-solid fa-bath mr-5"></i>2 Bathroom
              ...
              <div class="col-lg-7 col-md-12 mb-30">
                <div class="row mb-30">
                  <div class="col-md-12">
                    ...
                    <div class="section-title">Superior Room</div>
  
                    <p>
                    A well-appointed 3-bedroom, 2-bath superior room offering 600 sqft of space for up to 4 guests. This room blends comfort with style, featuring premium furnishings, large windows for natural light, and a warm ambiance. Whether you’re traveling with family or friends, the superior room offers ample space, ideal for extended stays or those seeking a little more room to relax and enjoy their time together.
                    </p>
                  </div>
                </div>
                <div class="row">
