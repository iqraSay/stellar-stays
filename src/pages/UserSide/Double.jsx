        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-8 col-md-12 text-center">
              ...
              <h1>Double Room</h1>
              <div class="details">
                <i class="fa-solid fa-bed mr-5"></i>2 Bed
                <i class="fa-solid fa-expand mr-5"></i>700 Sqm
            ...
            <div class="col-lg-7 col-md-12 mb-30">
              <div class="row mb-30">
                <div class="col-md-12">
                  ...
                  <div class="section-title">Double Room</div>

                  <p>
                  Offering 4 bedrooms and 2 bathrooms, the double room spans 700 sqft of space, providing ample room for up to 4 guests. Perfect for small groups or families, it features a spacious living area and modern comforts. The layout ensures privacy, with each guest enjoying their own dedicated space while also allowing for shared moments in the common areas. It’s an excellent choice for a relaxing and practical stay.
                  </p>
                </div>
              </div>
              <div class="row">
